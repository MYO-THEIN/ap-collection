...
payment_type_pg = st.Page(
    title="Payment Type", icon="💰", page="pages/2_Payment_Type.py"
)

# Stock Category
stock_category_pg = st.Page(
    title="Stock Category", icon="👕", page="pages/3_Stock_Category.py"
)

# Customer
customer_pg = st.Page(
    title="Customer", icon="🧑", page="pages/4_Customer.py"
)

# Order
order_pg = st.Page(
    title="Order", icon="🛒", page="pages/5_Order.py"
)
...
monthly_report_pg = st.Page(
    title="Monthly Report", icon="🗓️", page="pages/7_Monthly_Report.py"
)
